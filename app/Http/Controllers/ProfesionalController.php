...
class ProfesionalController extends Controller
{
    public function enviarSolicitud(Request $request){
        ...
        $request['rut']="15971802";
        $request['nombre']="jose";
        $request['aPaterno']="martine";
        $request['aMaterno']="choche";
        $request['telefono']="asda";
        $request['correo']="123468";
        $request['direccion']="hlkahfa 1241";
        $request['especialidad']="hlkahfa 1241";
