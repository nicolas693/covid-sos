    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <label style="margin-top: 15px;">Acciones:</label>
            <div  class="col-md-12 border">
                ...
                <input type="hidden" name="estado" value={{$profesional->estado}}>
                <input type="hidden" name="user_id" value="">
                <input type="hidden" name="establecimiento" value="">
                ...
                <div class="form-group" style="margin-top: 15px;display:block" id="caja_establecimiento">
                ...
                <div  class="form-group"  style="margin-top: 15px;display:none" id="caja_estado">
                    ...
                    <div>
                        <select class="form-control" name="estadoProfesional" id="estadoProfesional" value="">
                            ...
                            <option value="asignado"  @if ($profesional->estado== "asignado")selected="selected"@endif>Asignado</option>
                            <option value="no ubicable"  @if ($profesional->estado== "no ubicable")selected="selected"@endif>No ubicable</option>
                        </select>
                    </div>
                </div>
