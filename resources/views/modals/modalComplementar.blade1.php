...
<script>
    ...
    $(document).ready(function() {
        ...
        if (comple['pacienteCriticoCurso'] != '') {
            $('#pacienteCriticoCurso').fadeIn();
        }

        if (comple['ventilacionMecanicaCurso'] != '') {
            $('#ventilacionCurso').fadeIn();
        }

        if (comple['adminEstadoCurso'] != '') {
            $('#adminEstadoCurso').fadeIn();
        }

        if (comple['urgenciaDesastresCurso'] != '') {
            $('#urgenciaDesastresCurso').fadeIn();
        }

        if (comple['adultoMayorCurso'] != '') {
            $('#adultoMayorCurso').fadeIn();
        }

        if (comple['infeccionesRespiratoriasCurso'] != '') {
